window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function AppearanceRow({ t, setTheme, useStore, applyCustomTheme }) {
			const preference = useStore((s) => s.preference);
			const [customOpen, setCustomOpen] = (0, react.useState)(false);
			const [brand, setBrand] = (0, react.useState)("#4f46e5");
			const onCubeClick = (id) => {
				if (id === "custom") {
					if (applyCustomTheme) applyCustomTheme(brand);
				} else {
					setTheme(id);
				}
			...
			const onBrandChange = (value) => {
				setBrand(value);
				if (applyCustomTheme) applyCustomTheme(value);
			};
			const onImagePick = (event) => {
				...
				reader.onload = () => {
					fetch("http://127.0.0.1:3091/appearance", {
						method: "POST",
						headers: { "Content-Type": "application/json" },
						body: JSON.stringify({ config: { backgroundImage: reader.result } })
					});
				};
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsx)("div", {
					...
					style: { display: "flex", flexDirection: "column", gap: 12, padding: "12px 0 4px" },
					children: [(0, react_jsx_runtime.jsxs)("label", {
						style: { display: "flex", alignItems: "center", gap: 10, fontSize: 13, color: "var(--dsw-alias-label-primary)" },
						children: [(0, react_jsx_runtime.jsx)("span", { children: t("appearance.customBrand") }), (0, react_jsx_runtime.jsx)("input", {
							type: "color",
							value: brand,
							style: { width: 40, height: 30, border: "1px solid var(--dsw-alias-border-l2)", borderRadius: 6, padding: 2, cursor: "pointer", background: "none" },
							onChange: (e) => {
								onBrandChange(e.target.value);
							}
						})]
					}), (0, react_jsx_runtime.jsxs)("label", {
						style: { display: "flex", alignItems: "center", gap: 10, fontSize: 13, color: "var(--dsw-alias-label-secondary)" },
						children: [(0, react_jsx_runtime.jsx)("span", { children: t("appearance.customBackground") }), (0, react_jsx_runtime.jsx)("input", {
							type: "file",
							accept: "image/*",
		...
		*/
		...
		const zh = {
			...
			"appearance.customBrand": "主题色",
			"appearance.customBackground": "背景图"
		};
		...
		const en = {
			...
			"appearance.customBrand": "Brand color",
			"appearance.customBackground": "Background image"
		};
		//#endregion
		...
		*/
		function apply(ctx) {
			...
			const injected = (actions) => {
				...
				return { setTheme: (id) => {
					theme.setTheme(id);
				}, applyCustomTheme: (brand) => {
					if (!customRegistered) {
						try {
							theme.register({ id: "custom", colorScheme: "light", tokens: { "--dsw-alias-brand-primary": { light: brand, dark: brand } } });
						} catch {}
						customRegistered = true;
					}
					theme.overrideTokens("custom-appearance", { "--dsw-alias-brand-primary": { light: brand, dark: brand } });
